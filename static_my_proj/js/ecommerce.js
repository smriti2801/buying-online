$(document).ready(function(){
			...
			productForm.submit(function(event){
												...
												$.ajax({
															...
															success: function(data){
																						...
																						if (data.added){
																							submitSpan.html("<button class='btn btn-primary' type='submit'>Remove</button>")
	...
	function refreshCart(){
		...
		$.ajax({
			...
			success: function(data){
				//console.log(data)
				var itemRemoveForm = $('.remove-form')
				if (data.products.length > 0){
					console.log("has products in it")
					productRows.html(" ")
					...
					$.each(data.products, function(index, value){
						console.log(value)
						var newCartItemRemove = itemRemoveForm.clone()
	...
	} // refreshCart function finishes here
