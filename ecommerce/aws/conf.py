...
AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID',"AKIAJNDPCOSWTK452DZQ")
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY',"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")
